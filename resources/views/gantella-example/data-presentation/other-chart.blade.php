...
@section('styles')
  ...
  <!-- JQVMap -->
  <link href="{{ asset('gantella-master/vendors/jqvmap/dist/jqvmap.min.css') }}" rel="stylesheet"/>
@endsection
...
@section('scripts')
  ...
  <!-- JQVMap -->
  <script src="{{ asset('gantella-master/vendors/jqvmap/dist/jquery.vmap.js') }}"></script>
  <script src="{{ asset('gantella-master/vendors/jqvmap/dist/maps/jquery.vmap.world.js') }}"></script>
  <script src="{{ asset('gantella-master/vendors/jqvmap/dist/maps/jquery.vmap.usa.js') }}"></script>
  <script src="{{ asset('gantella-master/vendors/jqvmap/examples/js/jquery.vmap.sampledata.js') }}"></script>
  <!-- easy-pie-chart -->
  <script src="{{ asset('gantella-master/vendors/jquery.easy-pie-chart/dist/jquery.easypiechart.min.js') }}"></script>
