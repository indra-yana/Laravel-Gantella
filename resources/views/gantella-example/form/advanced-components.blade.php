...
@section('title', 'Advanced Components')
...
@section('styles')
  ...
  <link href="{{ asset('gantella-master/vendors/bootstrap-datetimepicker/build/css/bootstrap-datetimepicker.css') }}" rel="stylesheet">
  <!-- Ion.RangeSlider -->
  <link href="{{ asset('gantella-master/vendors/normalize-css/normalize.css') }}" rel="stylesheet">
  <link href="{{ asset('gantella-master/vendors/ion.rangeSlider/css/ion.rangeSlider.css') }}" rel="stylesheet">
  <link href="{{ asset('gantella-master/vendors/ion.rangeSlider/css/ion.rangeSlider.skinFlat.css') }}" rel="stylesheet">
  <!-- Bootstrap Colorpicker -->
  <link href="{{ asset('gantella-master/vendors/mjolnic-bootstrap-colorpicker/dist/css/bootstrap-colorpicker.min.css') }}" rel="stylesheet">

  <link href="{{ asset('gantella-master/vendors/cropper/dist/cropper.min.css') }}" rel="stylesheet">
@endsection
          ...
          <div class="row">
            <div class="col-md-9">
              <div class="img-container">
                <img id="image" src="{{ asset('gantella-master/production/images/cropper.jpg') }}" alt="Picture">
              </div>
            </div>
            <div class="col-md-3">
...
@section('scripts')
  ...
  <!-- bootstrap-daterangepicker -->
    ...
    <!-- bootstrap-datetimepicker -->    
    <script src="{{ asset('gantella-master/vendors/bootstrap-datetimepicker/build/js/bootstrap-datetimepicker.min.js') }}"></script>
    <!-- Ion.RangeSlider -->
    <script src="{{ asset('gantella-master/vendors/ion.rangeSlider/js/ion.rangeSlider.min.js') }}"></script>
    <!-- Bootstrap Colorpicker -->
    <script src="{{ asset('gantella-master/vendors/mjolnic-bootstrap-colorpicker/dist/js/bootstrap-colorpicker.min.js') }}"></script>
    <!-- jquery.inputmask -->
    <script src="{{ asset('gantella-master/vendors/jquery.inputmask/dist/min/jquery.inputmask.bundle.min.js') }}"></script>
    <!-- jQuery Knob -->
    <script src="{{ asset('gantella-master/vendors/jquery-knob/dist/jquery.knob.min.js') }}"></script>
    <!-- Cropper -->
    <script src="{{ asset('gantella-master/vendors/cropper/dist/cropper.min.js') }}"></script>
