                ...
                <div class="well profile_view">
                  <div class="col-sm-12">
                    ...
                    <div class="right col-xs-5 text-center">
                      <img src="{{ asset('gantella-master/production/images/img.jpg') }}" alt="" class="img-circle img-responsive">
                    </div>
                  </div>
              ...
              <div class="col-md-4 col-sm-4 col-xs-12 profile_details">
                <div class="well profile_view">
                  <div class="col-sm-12">
                    ...
                    <div class="right col-xs-5 text-center">
                      <img src="{{ asset('gantella-master/production/images/user.png') }}" alt="" class="img-circle img-responsive">
                    </div>
                  </div>
                  <div class="col-xs-12 bottom text-center">
                    <div class="col-xs-12 col-sm-6 emphasis">
