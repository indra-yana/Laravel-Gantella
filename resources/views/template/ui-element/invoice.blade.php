            ...
            <section class="content invoice">
              ...
              <div class="row">
                ...
                <div class="col-xs-6">
                  ...
                  <img src="{{ asset('gantella-master/production/images/visa.png') }}" alt="Visa">
                  <img src="{{ asset('gantella-master/production/images/mastercard.png') }}" alt="Mastercard">
                  <img src="{{ asset('gantella-master/production/images/american-express.png') }}" alt="American Express">
                  <img src="{{ asset('gantella-master/production/images/paypal.png') }}" alt="Paypal">
